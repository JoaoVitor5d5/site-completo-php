...
<head>
    ...
    <style>
        ...
        div.one {
            background-image: url('https://images7.alphacoders.com/857/thumbbig-857340.webp');
...
<body>
    ...
    <div class="one">
        <br><br><br><br><br><br><h1> FILMES </h1><br><br><br><br><br><br>
    </div>
    <?php 
                    include_once("conection.php");
                    $result_usuari = ' SELECT id, nome, apelido, ano, genero, imagem, descricao, assistir, feitoPor, aprovadoPor FROM filmesOf';
