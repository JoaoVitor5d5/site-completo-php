...
<head>
    ...
    <style>
        ...
        div.one {
            background-image: url('https://wallpaperaccess.com/full/3138665.jpg');
...
<body>
    ...
    <div class="one">
        <br><br><br><br><br><br><h1> SÉRIES </h1><br><br><br><br><br><br>
    </div>
    <?php 
                    include_once("conection.php");
                    $result_usuari = ' SELECT id, nome, apelido, ano, genero, episodios, status, imagem, descricao, assistir, feitoPor, aprovadoPor FROM seriesOf';
