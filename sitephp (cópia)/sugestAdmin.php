...
<head>
    ...
    <title>Sugestões para o Admin</title>
...
<body>
    ...
    <?php 
            ...
            if($_SESSION['tipo'] == 'anime' || $_POST['tipo'] == 'anime'){
                print("<div class='one'>");
                    print("<br><br><br><br><br><br><h1> ANIMES </h1><br><br><br><br><br><br>");
                    print("</div>");
                    $result_usuari = ' SELECT nome, apelido, ano, genero, episodios, status, imagem, descricao, assistir, manga, ler, feitoPor FROM animes ';
                    ...
                    while($row = mysqli_fetch_assoc($resultado_usuari)){
                        ...
                        print("<form action='itens2.php' method='post'>"); 
                    ...
                    print("<div class='one'><br><br><br><br><br><br><h1> FILMES </h1><br><br><br><br><br><br></div>");
                    include_once("conection.php");
                    $result_usuari = ' SELECT id, nome, apelido, ano, genero, imagem, descricao, assistir, feitoPor FROM filmes';
                    $resultado_usuari = mysqli_query($conn, $result_usuari);
                    ...
                    print("<div class='one'><br><br><br><br><br><br><h1> JOGOS </h1><br><br><br><br><br><br></div>");
                    $result_usuari = ' SELECT id, nome, apelido, ano, genero, imagem, descricao, preco, feitoPor FROM jogos';
                    $resultado_usuari = mysqli_query($conn, $result_usuari);
                    ...
                    print("<div class='one'><br><br><br><br><br><br><h1> MANGÁS </h1><br><br><br><br><br><br></div>");
                    $result_usuari = ' SELECT id, nome, apelido, ano, genero, capitulos, status, imagem, descricao, ler, feitoPor FROM mangas';
                    $resultado_usuari = mysqli_query($conn, $result_usuari);
                    ...
                    print("<div class='one'><br><br><br><br><br><br><h1> SÉRIES </h1><br><br><br><br><br><br></div>");
                    $result_usuari = ' SELECT id, nome, apelido, ano, genero, episodios, status, imagem, descricao, assistir, feitoPor FROM series';
                    $resultado_usuari = mysqli_query($conn, $result_usuari);
