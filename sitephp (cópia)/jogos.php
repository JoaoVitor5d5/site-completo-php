...
<head>
    ...
    <style>
        ...
        div.one {
            background-image: url('https://c4.wallpaperflare.com/wallpaper/625/387/755/arcane-jinx-league-of-legends-league-of-legends-riot-games-4k-hd-wallpaper-preview.jpg');
...
<body>
    ...
    <div class="one">
        <br><br><br><br><br><br><h1> JOGOS </h1><br><br><br><br><br><br>
    </div>
    <?php 
                    include_once("conection.php");
                    $result_usuari = ' SELECT id, nome, apelido, ano, genero, imagem, descricao, preco, feitoPor, aprovadoPor FROM jogosOf';
