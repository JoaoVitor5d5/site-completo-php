...
<body>
    ...
    if($_POST['tipo'] == 'anime'){
        ...
        print("<p>Mangá? ".$_POST['manga']." </p><br>");
        if($_POST['manga'] == "sim"){
            print("</strong><br><a href=".$_POST['ler'].">leia aqui</a></p><br>");
        }
        print("<p>Descrição:<br><strong>".$_POST['descricao']."</strong></p>");
        print("<br><p>Feito Por: <strong>".$_POST['feitoPor']."</strong>  Aprovado Por: <strong>".$_POST['aprovado']."</strong></p>");
        print("</div>");
        print("</div>");
        ...
        if(isset($_SESSION['admin'])){
                        print("<form action='apagarItem.php' method='post'>"); 
                            ...
                            print("<input type='text' hidden name='id' value='".$_POST['id']."'>");
                            print("<input type='text' hidden name='aprovado' value='".$_POST['aprovado']."'>");
                            print("<input type='text' hidden name='tipo' value='anime'>");
                            print("<button type='submit' class='custom-btn btn-13' >Apagar</button>");
                        print("</form>");
                        print("<form action='editarItem.php' method='post'>"); 
                            print("<input type='text' hidden name='nome' value='".$_POST['nome']."'>");
                            print("<input type='text' hidden name='apelido' value='".$_POST['apelido']."'>");
                            print("<input type='text' hidden name='ano' value='".$_POST['ano']."'>");
                            print("<input type='text' hidden name='genero' value='".$_POST['genero']."'>");
                            ...
                            print("<input type='text' hidden name='aprovado' value='".$_POST['aprovado']."'>");
                            print("<input type='text' hidden name='tipo' value='anime'>");
                            print("<button type='submit' class='custom-btn btn-12' >Editar</button>");
                        print("</form>");
        ...
        if(isset($_SESSION['admin'])){
                        ...
                        print("<input type='text' hidden name='nome' value='".$_POST['nome']."'>");
                            ...
                            print("<input type='text' hidden name='id' value='".$_POST['id']."'>");
                            print("<input type='text' hidden name='tipo' value='jogo'>");
                            print("<button type='submit' class='custom-btn btn-13' >Editar</button>");
                        print("</form>");
