...
<head>
    ...
    <style>
        ...
        div.one {
            background-image: url('https://c4.wallpaperflare.com/wallpaper/434/806/524/blue-exorcist-okumura-rin-manga-wallpaper-preview.jpg');
...
<body>
    ...
    <div class="one">
        <br><br><br><br><br><br><h1> MANGÁS </h1><br><br><br><br><br><br>
    </div>
    <?php 
                    include_once("conection.php");
                    $result_usuari = ' SELECT id, nome, apelido, ano, genero, capitulos, status, imagem, descricao, ler, feitoPor, aprovadoPor FROM mangasOf';
